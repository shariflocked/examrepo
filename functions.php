...
function newtheme_scripts() {
	...
	wp_enqueue_style('newtheme-bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css');

	wp_enqueue_style('newtheme-fontawesome', get_template_directory_uri() . '/css/font-awesome.min.css');

	wp_enqueue_style( 'newtheme-style', get_stylesheet_uri() );



	wp_enqueue_script('newtheme-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery'), '3.3.7', true);
